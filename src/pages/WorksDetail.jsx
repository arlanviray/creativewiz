...
function WorksDetail() {
  ...
  const linkUrl = isAdvert
    ? "advert/" + _.kebabCase(advertType)
    : _.kebabCase(type)
  const linkText = isAdvert ? advertType : type
  const viewText =
    ["Website", "Wordpress", "WP-Shopify"].indexOf(type) !== -1 ? "Site" : type

  return (
    <>
      <Helmet>
        <title>{metaTitles.work + " | " + linkText + " | " + title}</title>
      </Helmet>
      ...
      <section className="work-details">
        {(() => {
          if (image) {
            ...
            return <div className="noimage theme-bg"></div>
          }
        })()}
          ...
          <div className="info">
            <div className="row">
              ...
              <div className="col">
                ...
                <div className="p-t-8">
                  <Link className="btn-card" to={"/work/" + linkUrl}>
                    All {linkText}
                  </Link>
                </div>
              </div>
