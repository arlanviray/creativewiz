    ...
    <>
      <section className="contact-intro">
        <div className="content max-width p-t-96 align-center">
          ...
          <div className="description font-size-lg">{documentToReactComponents(data.description)}</div>
        </div>
      </section>
        ...
        <div className="content max-width-md p-t-48">
          {
            (() => {
              if (actionData && actionData.sent === true) {
                return (
                  <div className="h2 align-center" dangerouslySetInnerHTML={{__html: actionData.message}}></div>
                )
                ...
                return (
                  <Form method="post" action="/contact">
                    ...
                    <div className="form-submit align-right">
                      <button className="btn-button" type="submit">Send Message</button>
                    </div>
                  </Form>
                )
              }
