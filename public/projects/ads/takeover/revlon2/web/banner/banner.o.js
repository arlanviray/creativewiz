...
$(document).ready(function(){
    ...
    function checkStorage()
    {
        ...
        {
        	TweenMax.to($('.products .prod'), 0.5, {css:{'top':-80}});
			TweenMax.to($('.products .prod'+ _thisStorageID), 0.5, {css:{'top':-100}});
    ...
    function trackEventProduct(thisID)
    {
    	switch(thisID){
			...
			case 3:
				...
				break;
			case 4:
				ADTECH.event('Banner display colour black');
				break;
			default:
				ADTECH.event('Banner display colour green');
		}
    }
